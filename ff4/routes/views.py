...
GROUPS = {
	...
	'alternate': {
		...
		'description': 'These routes are generally archived routes from the old version of the site. They generally fall into three classes: specialized routes (e.g. for a marathon), meme routes and routes for romhacks. They are not fully optimized, are not updated to the new variable structure, and have no tutorial information available. They are here primarily for archival purposes (or I have not yet bothered to convert them).',
	}
}
