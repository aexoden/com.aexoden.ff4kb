...
ROUTES = {
    ...
    'no64-excalbur-marathon-recovery-fusoya': {
        ...
        'description': 'This variant of no64-excalbur-marathon runs from immediately upon landing on the moon until Zeromus is defeated, and is primarily intended as a step route (and grind) recovery method.',
        'group': 'recovery',
        'enabled': True,
        'twin_safe': True,
        'complete': True,
