...
com.aexoden.ff4.maps = function()
{
    ...
    var canWrap = function() {
        return currentMapIndex == MAP_OVERWORLD || currentMapIndex == MAP_UNDERWORLD || currentMapIndex == MAP_MOON;
    };
    ...
    var updateMap = function(mapIndex, fullUpdate = true) {
        ...
        currentImage.src = "/static/img/maps-ultima/" + (drawOverlay ? "composite" : "base") + "/" + currentMapIndex.toString(16).padStart(4, "0").toUpperCase() + "-0.png";
    };
